...
function showAddToHomeScreen() {
    ...
    pwaInstallPrompt.style.bottom = '0rem';
    pwaInstallPrompt.style.left = '15.3rem';
    pwaInstallPrompt.style.right = '0rem';
    pwaInstallPrompt.style.padding = '0.5rem 36rem';
    pwaInstallPrompt.style.display = 'flex';
    pwaInstallPrompt.style.backgroundColor = '#3a0b47';
    pwaInstallPrompt.style.color = 'white';
    pwaInstallPrompt.style.fontFamily = 'monospace';
    pwaInstallPrompt.style.fontSize = '1.6rem';
    pwaInstallPrompt.style.borderRadius = '0px';
    ...
    setTimeout(hideAddToHomeScreen, 999999999);
